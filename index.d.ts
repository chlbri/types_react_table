...
/***
 * By chlbri
 * git repo : https://github.com/chlbri
 */
declare module 'react-table' {
  ...
  export interface ColumnInstance<
    D extends Record<string, unknown> = Record<string, unknown>,
  > extends mit<ColumnInterface<D>, 'id'>,
      ColumnInterfaceBasedOnValue<D>,
  ...
  export type TablePropGetter<D extends object> = PropGetter<
    D,
    TableProps
  >;
  ...
  //#region useExpanded
  export function useExpanded<D extends object = {}>(
    hooks: Hooks<D>,
  ): void;
  ...
  export function useFlexLayout<D extends object = {}>(
    hooks: Hooks<D>,
  ): void;
  ...
  export function usePagination<D extends object = {}>(
    hooks: Hooks<D>,
  ): void;
  ...
  //#region useRowSelect
  export function useRowSelect<D extends object = {}>(
    hooks: Hooks<D>,
  ): void;
  ...
  //#region useRowState
  export function useRowState<D extends object = {}>(
    hooks: Hooks<D>,
  ): void;
